            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="cost" id="cost" class="form-control @error('cost') is-invalid @enderror" value="{{ old('cost', '0.00') }}" step="0.01" min="0" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="unit_of_measure" id="unit_of_measure" class="form-control @error('unit_of_measure') is-invalid @enderror" value="{{ old('unit_of_measure') }}" placeholder="Ej: Pza, Kg, Lt, Caja">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="category_id" id="category_id" class="form-control @error('category_id') is-invalid @enderror">
                                ...
                                {{-- $categories es pasada desde ProductController@create --}}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="tax_type" id="tax_type" class="form-control @error('tax_type') is-invalid @enderror" required>
                                <option value="Gravado" {{ old('tax_type', 'Gravado') == 'Gravado' ? 'selected' : '' }}>Gravado</option>
                                <option value="Exento" {{ old('tax_type') == 'Exento' ? 'selected' : '' }}>Exento</option>
                                <option value="No Sujeto" {{ old('tax_type') == 'No Sujeto' ? 'selected' : '' }}>No Sujeto</option>
                            </select>
                ...
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="image_path_file">Elegir archivo...</label>
                    </div>
