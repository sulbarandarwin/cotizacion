...
@section('content_header')
    <h1 class="m-0 text-dark">Agregar Nuevo Cliente</h1>
@stop
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('clients.store') }}" method="POST">
                @csrf {{-- Protección contra CSRF, ¡muy importante! --}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="identifier" id="identifier" class="form-control @error('identifier') is-invalid @enderror" value="{{ old('identifier') }}" required>
                            @error('identifier')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
